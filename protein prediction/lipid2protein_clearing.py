...
if __name__ == "__main__":
    lipid_path = '5min human_size512_net95 10-100 10 square'
    ...
    dataset = core_lzj.L2PTissueClearing(path=lipid_path, transform=transform)
    ...
    # valid_dataset = Subset(dataset, list(range(2800, 3200)))
    # print('train_dataset length is', train_dataset.__len__())
    print('valid_dataset length is', dataset.__len__())
    ...
    save_path = '5min human_size512_net95 10-100 10 square protein'
    ...
    for im, name in valid_loader:
        ...
        img_l2p.save(os.path.join(save_path, name[0] + '-l2p' + '.tif'))
